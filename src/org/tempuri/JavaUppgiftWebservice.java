...
public class JavaUppgiftWebservice  implements java.io.Serializable {
    ...
    /**
     * Gets the i value for this JavaUppgiftWebservice.
     * 
     * @return i
     */
    public int getI() {
    ...
    /**
     * Sets the i value for this JavaUppgiftWebservice.
     * 
     * @param i
     */
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://tempuri.org/", "i"));
